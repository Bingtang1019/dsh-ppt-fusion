...
```sh
dsh plugin --profile <profile> add -w dsh-ppt-flashmade@0.4.0
```
...
`dsh-ppt-flashmade-0.4.0.tgz` from
`https://github.com/Bingtang1019/dsh-ppt-fusion/releases/tag/v0.4.0`, then

```sh
dsh plugin --profile <profile> add -w <downloads>/dsh-ppt-flashmade-0.4.0.tgz
```

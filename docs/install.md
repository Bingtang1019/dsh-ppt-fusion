...
```sh
dsh plugin --profile <profile> add -w dsh-ppt-flashmade@0.3.4
```
...
`dsh-ppt-flashmade-0.3.4.tgz` from
`https://github.com/Bingtang1019/dsh-ppt-fusion/releases/tag/v0.3.4`, then

```sh
dsh plugin --profile <profile> add -w <downloads>/dsh-ppt-flashmade-0.3.4.tgz
```

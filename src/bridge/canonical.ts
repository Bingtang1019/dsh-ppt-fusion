...
// Tier T1 (semantic) comparison of two `.pptx` packages, per plan §7.2 and Part C.
//
...
//
// The worktree diff (ADR-086) compares canonical maps directly, which is why this
// lives in `src/` rather than in the test support tree.
